...
/**
 * DetectCollision - this function checks if there could be a collision
 * with the wall in the next player advance
 * @x: next x coordinate
 * @y: next y coordinate
 * Return: true if collision is detected (Success), otherwise false.
*/
...
/**
 * isInsideMap - this function check if we continue within the map.
 * @x: next x coordinate
 * @y: next y coordinate
...
/**
 * getMapValue - this function checks if we continue within the map
...
/**
 * renderMap - this function renders the map
 *
*/
