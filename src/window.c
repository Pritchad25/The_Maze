...
/**
 * initializeWindow - this function initialize window to display the maze
...
/**
 * destroyWindow - this function destroy window when the game is over
 *
*/
...
/**
 * clearColorBuffer - this function clear buffer for every frame
 * @color: color buffer
*/
...
/**
 * renderColorBuffer - this function renders buffer for every frame
 *
*/
...
/**
 * drawPixel - this function assign a color to each pixel
