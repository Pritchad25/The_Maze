...
/**
 * horzIntersection - this function finds horizontal intersection with the wall
...
/**
 * vertIntersection - this function finds the vertical intersection
 * with the wall
 * @rayAngle: current ray angle
 *
 */
...
/**
 * castRay - this function performs the casting of each ray
 * @rayAngle: current ray angle
...
/**
 * castAllRays - this function casts of all rays.
 *
 */
...
/**
 * renderRays - this function draws all the rays
 *
 */
